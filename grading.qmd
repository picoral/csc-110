...
Again, some students find this grading "unfair" because it does not take into account their effort to answer the question. The goal, however, is to assess whether you understand the logic of how to solve the problem and you know how to to do in Python syntax. If you do not demonstrate that you know how to solve the problem, you will be awarded a zero.