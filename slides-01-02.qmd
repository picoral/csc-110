...
* As a group, write your answer to the previous exercise on a whiteboard
* Write on the whiteboard the name of a TA
* Submit your whiteboard answer to Gradescope (take a picture with a phone)
