...
Your output file name should be the original file name plus `"_result"` -- for example, if the file name is `"foo.txt"` the output file you create should be names `"foo_result.txt"`
