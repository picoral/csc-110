...
schedule <- read_excel("schedule.xlsx") %>% 
  mutate(formatted_date = format(date),
         formatted_start = format(week_start, "%b %d"))

assignments <- read_excel("assessment_schedule.xlsx") %>% 
  mutate(formatted_date = format(due_date))
```
...
-   `r schedule %>% filter(exam == "Final Exam" & term == "fall 2024") %>% pull(formatted_date)` -- `r schedule %>% filter(exam == "Final Exam" & term == "fall 2024") %>% pull(time)` in [room TBA]()
...
-   [Survey](https://uarizona.co1.qualtrics.com/jfe/form/SV_0q8KC0FwVhCiYD4) -- Due date: `r assignments %>% filter(assessment == "Survey") %>% pull(formatted_date)` at 7pm
...
-   [Functions](slides-02-01.html) [(pdf)](slides-02-01.pdf)
-   [Math in Python](slides-02-02.html) [(pdf)](slides-02-02.pdf)
...
-   [More on Functions](slides-03-01.html)  [(pdf)](slides-03-01.pdf)
-   [Built-in Python Functions](slides-03-02.html) [(pdf)](slides-03-02.pdf)
...
-   [More expressions](slides-04-01.html)  [(pdf)](slides-04-01.pdf)
-   [If statements](slides-04-02.html)  [(pdf)](slides-04-02.pdf)
-   [if elif else](slides-04-03.html)  [(pdf)](slides-04-03.pdf)
...
-   [while loop intro](slides-05-01.html)  [(pdf)](slides-05-01.pdf)
-   [loops + string](slides-05-02.html) [(pdf)](slides-05-02.pdf)
-   [while loop aggregation](slides-05-03) [(pdf)](slides-05-03.pdf)
...
-   [Lists](slides-06-01.html) [(pdf)](slides-06-01.pdf)
-   [random](slides-06-02.html) [(pdf)](slides-06-02.pdf)
...
-   [mutability](slides-07-01.html)  [(pdf)](slides-07-01.pdf)
-   [for loops with range](slides-07-02.html)  [(pdf)](slides-07-02.pdf)
...
-   [intro to dictionaries](slides-08-01.html)  [(pdf)](slides-08-01.pdf)
-   [`for x in list` loops](slides-08-02.html)  [(pdf)](slides-08-02.pdf)
