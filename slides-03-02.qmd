...
Your formula in your function should be Python code (in other words, do not just copy the formula above, make it so it uses **actual symbols for Python operators**)
